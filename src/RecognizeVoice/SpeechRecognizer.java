...
public class SpeechRecognizer {
    ...
    private LiveSpeechRecognizerExtention recognizer;
...
//        configuration.setUseGrammar(true);
     ...
     */
    public synchronized void startSpeechRecognition(TextField text) {
                    ...
                    while (speechRecognizerThreadRunning.get()) {
                        ...
                        if (!ignoreSpeechRecognitionResults.get()) {
                            ...
                            if (speechResult == null) {
                                ...
                                Platform.runLater(() -> {
                                    speechRecognitionResultProperty.set(speechRecognitionResult);
